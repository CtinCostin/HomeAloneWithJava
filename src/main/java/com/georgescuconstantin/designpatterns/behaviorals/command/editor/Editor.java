package main.java.com.georgescuconstantin.designpatterns.behaviorals.command.editor;

import main.java.com.georgescuconstantin.designpatterns.behaviorals.command.commands.*;
...
public class Editor {
    ...
    public void init() {
        JFrame frame = new JFrame("Text editor (type & use buttons, Good Luck!)");
